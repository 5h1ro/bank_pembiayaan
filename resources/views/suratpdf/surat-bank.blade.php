    ...
    <center>
            <table width=90%>
                <tr>
                    <td>
                    <center>
                        <img src="bismillah.png" width="10%"><br>
                        <font size="1"><i>Dengan menyebut nama Allah yang Maha Pengsaih lagi Maha Penyayang</i></font><br>
                        <br>
    ...
    <center>
            <table width=90%>
                <tr class="text2">
                    <td>
                    <center>
                        <img src="bismillah.png" width="30%"><br>

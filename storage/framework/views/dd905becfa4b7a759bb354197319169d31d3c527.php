									...
									<div class="row">
										<div class="col text-center pe-0 call-content">
											<div>
												...
												<button class="btn btn-danger-gradien btn-block btn-lg">END CALL</button>
												<div class="receiver-img"><img src="<?php echo e(asset('assets/images/other-images/receiver-img.jpg')); ?>" alt=""></div>
											</div>
										</div>
										<div class="col-sm-7 ps-0 caller-img"><img class="img-fluid" src="<?php echo e(asset('assets/images/other-images/caller.jpg')); ?>" alt=""></div>
									</div>
								</div>
								<!-- chat-history ends-->
								<!-- chat end-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pinjol\resources\views/apps/chat-video.blade.php ENDPATH**/ ?>
            ...
            <ul>
              ...
              <li>
                <div class="pricing-plan">
                  ...
                  <img class="bg-img" src="<?php echo e(asset('assets/images/dashboard/folder.png')); ?>" alt="">
                </div>
              </li>
              <li>
                <div class="pricing-plan">
                  ...
                  <img class="bg-img" src="<?php echo e(asset('assets/images/dashboard/folder1.png')); ?>" alt="">
                </div>
              </li>
            </ul>
          </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pinjol\resources\views/file-manager.blade.php ENDPATH**/ ?>
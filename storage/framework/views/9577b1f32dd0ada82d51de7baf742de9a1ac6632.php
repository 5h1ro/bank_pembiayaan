      ...
      <ul class="horizontal-menu">
                ...
                <div class="col mega-box">
                  <div class="link-section doted">
                    ...
                    <ul>
                      ...
                      <li><a href="<?php echo e(route('login-one')); ?>">Login with image</a></li>
                      <li><a href="<?php echo e(route('login-bs-validation')); ?>">Login with validation</a></li>
                      <li><a href="<?php echo e(route('sign-up')); ?>">Sign Up</a></li>
                      <li><a href="<?php echo e(route('sign-up-one')); ?>">SignUp with image</a></li>
                      <li><a href="<?php echo e(route('sign-up-two')); ?>">SignUp with image</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section dashed-links">
                    ...
                    <ul>
                      <li><a href="<?php echo e(route('search')); ?>">Search Website</a></li>
                      ...
                      <li><a href="<?php echo e(route('login-bs-validation')); ?>">Login validation</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul>
                      <li class="ps-0"><a href="<?php echo e(route('basic-template')); ?>">Basic Email</a></li>
                      <li class="ps-0"><a href="<?php echo e(route('email-header')); ?>">Basic With Header</a></li>
                      <li class="ps-0"><a href="<?php echo e(route('template-email')); ?>">Ecomerce Template</a></li>
                      <li class="ps-0"><a href="<?php echo e(route('template-email-2')); ?>">Email Template 2</a></li>
                      <li class="ps-0"><a href="<?php echo e(route('ecommerce-templates')); ?>">Ecommerce Email</a></li>
                      <li class="ps-0"><a href="<?php echo e(route('email-order-success')); ?>">Order Success</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul class="svg-icon">
                      <li><a href="<?php echo e(route('comingsoon')); ?>"> <i data-feather="file"> </i>Coming-soon</a></li>
                      <li><a href="<?php echo e(route('comingsoon-bg-video')); ?>"> <i data-feather="film"> </i>Coming-video</a></li>
                      <li><a href="<?php echo e(route('comingsoon-bg-img')); ?>"><i data-feather="image"> </i>Coming-Image</a></li>
                    </ul>
                    <div>
                      <h6>Other Soon</h6>
                    </div>
                    <ul class="svg-icon">
                      <li><a class="txt-secondary" href="<?php echo e(route('sample-page')); ?>"> <i data-feather="airplay"></i>Sample Page</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <li class="level-menu outside">
          ...
          <ul class="header-level-menu menu-to-be-close">
           <li>
              <a href="<?php echo e(route('file-manager')); ?>" data-original-title="" title=""> <i data-feather="git-pull-request"></i><span>File manager </span></a>
            </li>
            <li>
              <a href="#!" data-original-title="" title=""> <i data-feather="users"></i><span>Users</span></a>
              <ul class="header-level-sub-menu">
                <li>
                  <a href="<?php echo e(route('user-profile')); ?>" data-original-title="" title=""> <i data-feather="user"></i><span>User Profile</span></a>
                </li>
                <li>
                  <a href="<?php echo e(route('edit-profile')); ?>" data-original-title="" title=""> <i data-feather="user-minus"></i><span>User Edit</span></a>
                </li>
                <li>
                  <a href="<?php echo e(route('user-cards')); ?>" data-original-title="" title=""> <i data-feather="user-check"></i><span>Users Cards</span></a>
                </li>
              </ul>
            </li>
            <li>
              <a href="<?php echo e(route('kanban')); ?>" data-original-title="" title=""> <i data-feather="airplay"></i><span>Kanban Board</span></a>
            </li>
            <li>
              <a href="<?php echo e(route('bookmark')); ?>" data-original-title="" title=""> <i data-feather="heart"></i><span>Bookmark</span></a>
            </li>
            <li>
              <a href="<?php echo e(route('social-app')); ?>" data-original-title="" title=""> <i data-feather="zap"></i><span>Social App </span></a>
            </li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <ul class="cart-dropdown onhover-show-div">
            ...
            <li><a class="btn btn-block w-100 mb-2 btn-primary view-cart" href="<?php echo e(route('cart')); ?>">Go to shoping bag</a><a class="btn btn-block w-100 btn-secondary view-cart" href="<?php echo e(route('checkout')); ?>">Checkout</a></li>
          </ul>
        </li>
        <li class="onhover-dropdown">
...
<?php /**PATH C:\xampp\htdocs\pinjol\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>